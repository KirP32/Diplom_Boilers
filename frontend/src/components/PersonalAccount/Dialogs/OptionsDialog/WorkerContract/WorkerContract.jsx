  ...
  return (
    <Document onRender={handleOnLoad}>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.paragraph}>
          1.4. Исполнитель выполняет Работы в отношении Продукции, установленной
        ...
        <Text style={styles.paragraph}>
          ...
          предоставления гарантии на Продукцию, установленными Изготовителем.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          гарантийный срок, в течение которого должны выполняться Работы.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          оборудование и инструмент, приобретаемые Исполнителем за свой счет.
          Заказчик не возмещает Исполнителю стоимость расходов на приобретение
          или аренду оборудования и инструментов.
        </Text>

        <Text style={styles.paragraph}>
          2.6. Исполнитель должен соответствовать всем требованиям,
          предъявляемым российским законодательством к организациям,
          осуществляющим работы по техническому обслуживанию и ремонту газового
          оборудования, включая получение в установленном порядке допуска к
        ...
        <Text style={styles.paragraph}>
          ...
          соответствовать всем предъявляемым законодательством РФ требованиям, в
          том числе, иметь соответствующую профессиональную подготовку согласно
          требованиям российского законодательства, иметь установленные
          российским законодательством документы на право выполнения работ по
          монтажу, пусконаладке и обслуживанию газового оборудования.
        </Text>

        <Text style={styles.paragraph}>
          2.8. Специалисты Исполнителя, осуществляющие Работы, должны иметь
          действующий именной сертификат, выданный Заказчиком в ходе очного
          обучения по ремонту и обслуживанию Продукции.
        </Text>

        <Text style={styles.paragraph}>
          2.9. Исполнитель обязан выполнять Работы по устранению недостатка или
          неисправности Продукции в течение 24 часов с момента обращения
          потребителя к Исполнителю. Работы должны выполняться в месте установки
          Продукции посредством выезда к потребителю специалистов Исполнителя,
          соответствующих требованиям вышеуказанных пунктов настоящего Договора.
        </Text>
        ...
        <View style={styles.bulletItem}>
          <Text style={styles.paragraph}>
            ...
            подтверждающих обращения потребителей, включая, среди прочего, любые
            запросы и претензии в соответствии с действующим законодательством
            Российской Федерации, а также по требованию Заказчика
            незамедлительно направлять ему копии таких запросов и претензий;
          </Text>
        </View>
        <View style={styles.bulletItem}>
          <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          размере 30%.{"\n"}
          Запасные части приобретаются Исполнителем у уполномоченных Заказчиком
          на продажу запасных частей на территории Российской Федерации третьих
          лиц по отдельным договорам, при этом размер скидки остается
          неизменным.
        </Text>
        <Text style={styles.paragraph}>
          ...
          договору. Резерв запасных частей Исполнитель приобретает у Заказчика
          по договору с отсрочкой платежа.
        </Text>
        <Text style={styles.paragraph}>
          3.4. Исполнитель обязан передавать Заказчику вышедшие из строя
          запасные части, которые подлежали замене в течение 10 (Десяти) рабочих
          дней со дня проведения работ за счет Заказчика.
        </Text>
        ...
        <Text style={styles.paragraph}>
          4.3. Возмещаемая Заказчиком стоимость запасных частей определяется на
          основании документа, подтверждающего расходы на их приобретение у
          уполномоченных Заказчиком на продажу запасных частей на территории
          Российской Федерации третьих лиц.
        </Text>
        <Text style={styles.paragraph}>
          Возмещаемая стоимость запасных частей не должна превышать розничную
          стоимость с учетом скидки, предусмотренной пунктом 3.2 настоящего
          договора. В случае приобретения Исполнителем запасных частей по ценам,
          превышающим возмещаемую Заказчиком стоимость запасных частей (т. е.
          без учета скидки, предусмотренной пунктом 3.2 настоящего договора), их
          стоимость в части такого превышения Заказчиком не возмещается.
        </Text>

        <Text style={styles.paragraph}>
          4.4. Заказчик вправе в любое время изменять скидку на запчасти,
          указанную в п. 3.2 настоящего Договора путем направления Исполнителю
          электронного письма на адрес электронной почты Исполнителя, указанный
          в настоящем Договоре. Сторонами согласовано, что направляемые
          Заказчиком в этом случае электронные письма (письма по электронной
          почте) приравниваются к изменениям, совершенным Сторонами в письменной
          форме, и имеют обязательную для Сторон юридическую силу.
        </Text>
        <Text style={styles.paragraph}>
          4.5. По итогам изучения высланного Исполнителем отчета о выполненных
          Работах, Заказчик принимает решение об одобрении таких Работ, либо об
          отказе в одобрении Работ в полном объеме. Заказчик, в частности,
          вправе отказать в одобрении Работ, если они выполнены с недостатками
          по качеству или если они выполнены при отсутствии оснований для их
          выполнения.
        </Text>
        <Text style={styles.paragraph}>
          4.6. При одобрении/отказе в одобрении Работ, Заказчик направляет
          соответствующее письмо на электронную почту Исполнителя в течение 10
          рабочих дней с момента получения отчета Исполнителя.
        </Text>
        <Text style={styles.paragraph}>
          4.7. На основании подтверждающего письма с одобрением Работ,
          Исполнитель составляет и направляет Заказчику следующие документы:
        </Text>
        <View style={styles.bulletItem}>
          <Text style={styles.paragraph}>
            - два экземпляра акта сдачи-приемки выполненных Работ, подписанных
            уполномоченным должностным лицом Исполнителя, с отражением в них
            стоимости Работ и запасных частей в рублях;
          </Text>
        </View>
        <View style={styles.bulletItem}>
          <Text style={styles.paragraph}>
            - счет на оплату возмещения стоимости Работ и использованных для их
            выполнения запасных частей в рублях;
          </Text>
        </View>
        <View style={styles.bulletItem}>
          <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          календарных дней со дня получения Заказчиком от Исполнителя надлежащим
          образом оформленных и составленных с соблюдением требований настоящего
          Договора Акта выполненных Работ и Счета.
          {"\n"}
          ...
          средств с расчетного счета Заказчика в его кредитной организации.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          на лабораторной базе в г. Тула своими силами и за свой счет.
          Проживание и транспортные расходы на обучение оплачиваются
          Исполнителем.
        </Text>
        <Text style={styles.paragraph}>
          ...
          информации о новых изделиях и изменениях в изделиях, а также всей
          информации, которая имеет существенное значение для выполнения работ.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          продлевается на 1 (один) календарный год, если Стороны не уведомят
          друг друга в письменном виде о своем намерении прекратить настоящий
          Договор не позднее, чем за 30 (тридцать) дней до момента истечения его
          срока.
          {"\n"}
        ...
        <Text style={styles.paragraph}>
          ...
          обязана незамедлительно сообщать другой Стороне по электронной почте о
          наступлении и прекращении упомянутых обстоятельств. Если
          соответствующая Сторона не сообщает о наступлении обстоятельств
          непреодолимой силы в течение 20 (двадцати) календарных дней с даты их
          первого вмешательства в выполнение настоящего Договора, она лишается
          права ссылаться на такие обстоятельства в обоснование неисполнения
        ...
        <Text style={styles.paragraph}>
          ...
          или частично, в каковом случае ни одна из Сторон не вправе требовать
          от другой Стороны какой-либо компенсации возможных убытков.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          течение всего срока действия настоящего Договора и 2 (двух) лет после
        ...
        <Text style={styles.paragraph}>
          ...
          настоящего Договора (или на иной адрес, который соответствующая
        ...
        <Text style={styles.paragraph}>
          ...
          Арбитражного суда г. Тулы в соответствии с применимым
          законодательством.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          согласно российскому законодательству и не создает такого рода
          отношений.
        </Text>
        <Text style={styles.paragraph}>
      ...
      <Page size="A4" style={styles.page}>
        ...
        {/* Подписи сторон */}
        <Text
          style={[styles.paragraph, { marginTop: 50, textAlign: "center" }]}
        >
          Подписи сторон
        </Text>
