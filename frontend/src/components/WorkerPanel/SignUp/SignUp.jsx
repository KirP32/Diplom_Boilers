...
export default function SignUp({ updateRegFlag, ...props }) {
  ...
  function validate() {
    ...
    const passwordError =
      (password.length < 1 && password_check.length) < 1 &&
  ...
  return (
    <div className={styles.sign_up__wrapper}>
      <div className={styles.sign_up__wrapper__content}>
        ...
        <div className={styles.sign_up__inputs}>
          ...
          <Input
            ...
            onChange={(event) => setPassword_check(event.target.value)}
          />
          {errors.password && (
            <h5 className={styles.error}>Пароли не совпадают</h5>
          )}
          <Input
            type="email"
            placeholder="Почта"
        ...
        <div className={styles.sign_up__register}>
          <Button
            ...
            className={styles.sign_up__register__button}
          >
            Регистрация
          </Button>
      ...
      {sign_failure && (
        <div className={styles.registration__failed}>
